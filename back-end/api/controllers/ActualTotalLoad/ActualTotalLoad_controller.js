...
const action = require('./ActualTotalLoad_queries');
...
// ================================================================================================================================================
exports.ActualTotalLoad_date = (req, res, next) => {
...
// ================================================================================================================================================
exports.ActualTotalLoad_month = (req, res, next) => {
    const areaname = req.params.areaname;
    const rescode = req.params.rescode;
    const data_format = (req.query.format !== 'json' && req.query.format !== 'csv')? 'json':req.query.format;
...
// ================================================================================================================================================
exports.ActualTotalLoad_year = (req, res, next) => {
    const areaname = req.params.areaname;
    const rescode = req.params.rescode;
    const data_format = (req.query.format !== 'json' && req.query.format !== 'csv')? 'json':req.query.format;
