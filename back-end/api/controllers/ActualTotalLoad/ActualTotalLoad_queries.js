                    ...
                    if(group === 'date'){
                        ...
                        .then(documents => {
                            if(documents.length === 0) next(errors.NO_DATA);
                                ...
                                const path = process.env.DOWNLOADS +'/ActualTotalLoad/ActualTotalLoad_1a_' + n_fy + "-" + n_month + "-" + n_day + "-" + now.getMilliseconds() + ".csv";
                    ...
                    // ------------------------------------------------------------------------------------------------------------------------------
                        ...
                        ActualTotalLoad.aggregate([
                            ...
                            if(documents.length === 0) next(errors.NO_DATA);
                                ...
                                const path = process.env.DOWNLOADS + '/ActualTotalLoad/ActualTotalLoad_1b_' + n_fy + "-" + n_month + "-" + n_day + "-" + now.getMilliseconds() + ".csv";
