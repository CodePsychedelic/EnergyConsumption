...
const action = require('./ActualvsForecast_queries');
...
// get http://localhost:8765/energy/api/ActualTotalLoad/Greece/PT60M/date/2018-01-04
// returns recorded load values for day 04/01/2018 from actual total load document. (grouped by day)
// ================================================================================================================================================
exports.ActualvsForecast_date = (req, res, next) => {
...
// get http://localhost:8765/energy/api/ActualTotalLoad/Greece/PT60M/month/2018-01
// returns recorded load values for month 01/2018 (grouped by month)
// ================================================================================================================================================
exports.ActualvsForecast_month = (req, res, next) => {
    const areaname = req.params.areaname;
    const rescode = req.params.rescode;
    const data_format = (req.query.format !== 'json' && req.query.format !== 'csv')? 'json':req.query.format;
...
// get http://localhost:8765/energy/api/ActualTotalLoad/Greece/PT60M/year/2018
// returns recorded load values for year 2018. (grouped by year)
// ================================================================================================================================================
exports.ActualvsForecast_year = (req, res, next) => {
    const areaname = req.params.areaname;
    const rescode = req.params.rescode;
    const data_format = (req.query.format !== 'json' && req.query.format !== 'csv')? 'json':req.query.format;
