...
// /energy/api/DayAheadTotalLoadForecast/.. ENDPOINT
// ================================================================================================================================================
describe('GET /energy/api/DayAheadTotalLoadForecast/../year/YYYY', () => {
    ...
    it('Should create 200 - OK (ADMIN)', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/Greece/PT60M/year/2018')
        ...
        .end(async (err, res) => {
            if(!err){
                ...
                expect(res.body.results[0]).toHaveProperty('DayAheadTotalLoadForecastByMonthValue');
                // ------------------------------------------------------------------------

                // values 
                // ------------------------------------------------------------------------
                expect(res.body.results[0].Source).toBe('entso-e');
                expect(res.body.results[0].Dataset).toBe('DayAheadTotalLoadForecast');
                ...
                expect(res.body.results[0].DayAheadTotalLoadForecastByMonthValue).toBe(r[0].total);
                // ------------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------------------------------------------------------------
    it('Should create 200 - OK (ADMIN)', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/Greece/PT60M/year/2018?format=csv')
        .set({'X_OBSERVATORY_AUTH':token})
        .expect(200)
        .end(async (err, res) => {
            if(!err){
             ...
             try{
                ...
                expect(row[8]).toBe(r[0].total.toString());
    ...
    it('Should create 400 - BAD REQUEST(RESOLUTION)', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/Greece/PT40M/year/2018')
        .set({'X_OBSERVATORY_AUTH':token})
        .expect(400)
        .end((err, res) => {
            if(!err){
    ...
    it('Should create 400 - BAD REQUEST (DATE)', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/Greece/PT60M/year/201')
        .set({'X_OBSERVATORY_AUTH':token})
        .expect(400)
        .end((err, res) => {
            if(!err){
    ...
    it('Should create 400 - BAD REQUEST (FORM)', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/PT60M/year/2018')
        .set({'X_OBSERVATORY_AUTH':token})
        .expect(400)
        .end((err, res) => {
            if(!err){
    ...
    // ---------------------------------------------------------------------------------------------------------------------------
       ...
       // GET - 403 NO_DATA /energy/api/DayAheadTotalLoadForecast/Greece/PT30M/date/2018-01-04
    // ---------------------------------------------------------------------------------------------------------------------------
    it('Should create 403 - NO DATA - AREANAME', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/aUST/PT60M/year/2018')
        .set({'X_OBSERVATORY_AUTH':token})
        .expect(403)
        .end((err, res) => {
            if(!err){
    ...
    it('Should create 403 - NO DATA - TIMERES', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/Greece/PT30M/year/2018')
        .set({'X_OBSERVATORY_AUTH':token})
        .expect(403)
        .end((err, res) => {
            if(!err){
   ...
   // GET - 403 NO_DATA /energy/api/DayAheadTotalLoadForecast/Greece/PT30M/date/2018-01-04
    ...
    it('Should create 403 - NO DATA - YEAR', async done => {
        request.get('/energy/api/DayAheadTotalLoadForecast/Greece/PT60M/year/2028')
        .set({'X_OBSERVATORY_AUTH':token})
        .expect(403)
        .end((err, res) => {
            if(!err){
